...
export const CIRCUIT_IMAGES: Record<string, string> = {
  'Albert Park Grand Prix Circuit':  '/images/circuits/앨버트 파크 서킷.png',
  'Shanghai International Circuit':  '/images/circuits/상하이 인터내셔널 서킷.png',
  'Suzuka Circuit':                  '/images/circuits/스즈카 서킷.png',
  'Bahrain International Circuit':   '/images/circuits/바레인 인터내셔널 서킷.png',
  'Jeddah Corniche Circuit':         '/images/circuits/제다 코니쉬 서킷.png',
  'Miami International Autodrome':   '/images/circuits/마이애미 인터내셔널 오토드롬.png',
  'Autodromo Enzo e Dino Ferrari':   '/images/circuits/이몰라 서킷.jpg',
  'Circuit de Monaco':               '/images/circuits/시르퀴 드 모나코.png',
  'Circuit de Barcelona-Catalunya':  '/images/circuits/시르쿠이트 데 바르셀로나.png',
  'Circuit Gilles Villeneuve':       '/images/circuits/시르퀴 질 빌뇌브.png',
  'Red Bull Ring':                   '/images/circuits/레드불링.png',
  'Silverstone Circuit':             '/images/circuits/실버스톤 서킷.png',
  'Circuit de Spa-Francorchamps':    '/images/circuits/스파 프랑코샹 서킷.png',
  'Hungaroring':                     '/images/circuits/헝가로링.png',
  'Circuit Park Zandvoort':          '/images/circuits/잔드보르트 서킷.png',
  'Autodromo Nazionale di Monza':    '/images/circuits/몬자서킷.png',
  'Baku City Circuit':               '/images/circuits/바쿠 시티 서킷.png',
  'Marina Bay Street Circuit':       '/images/circuits/마리나베이 서킷.png',
  'Circuit of the Americas':         '/images/circuits/서킷 오브 디 아메리카스.png',
  'Autódromo Hermanos Rodríguez':    '/images/circuits/아우토드로모 에르마노스 로드리게스.png',
  'Autódromo José Carlos Pace':      '/images/circuits/인터라고스 서킷.png',
  'Las Vegas Strip Street Circuit':  '/images/circuits/라스베가스 스트립 서킷.png',
  'Losail International Circuit':    '/images/circuits/루사일 인터내셔널 서킷.png',
  'Yas Marina Circuit':              '/images/circuits/야스 마리나 서킷.png',
  'Madring':                         '/images/circuits/마드링.png',
}
...
export async function fetchSeasonRaces(year: number): Promise<Race[]> {
  ...
  const races: JolpicaRaceItem[] = racesData.MRData?.RaceTable?.Races ?? []
  return races.map((r: JolpicaRaceItem): Race => ({
    round:        Number(r.round),
    name:         GP_NAMES[r.raceName] ?? r.raceName,
    circuit:      CIRCUIT_NAMES[r.Circuit.circuitName] ?? r.Circuit.circuitName,
    circuitImage: CIRCUIT_IMAGES[r.Circuit.circuitName],
